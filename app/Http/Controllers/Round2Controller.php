...
class Round2Controller extends Controller
{
    ...
    public function update(ApplicantRequest $applicantRequest, Round2Request $round1Request, int $id)
    {
        ...
        $round1 = $this->round2Service->updateRound2($id, $round1Request->validated());
        return response()->json([
